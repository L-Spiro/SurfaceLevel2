...
#define SL2_ID( VULKAN, DX, METAL, OGLINTERNAL, OGLTYPE, OGLBASE )				#VULKAN, #DX, #METAL, #OGLINTERNAL, #OGLTYPE, #OGLBASE, SL2_ ## VULKAN, SL2_ ## DX, SL2_ ## METAL, SL2_KIF_ ## OGLINTERNAL, SL2_KT_ ## OGLTYPE, SL2_KBIF_ ## OGLBASE
		...
		{ SL2_ID( VK_FORMAT_R16_SFLOAT, DXGI_FORMAT_R16_FLOAT, MTLPixelFormatR16Float, GL_R16F, GL_HALF_FLOAT, GL_RED ),									0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, true, nullptr, SL2_CONV_F( CFormat::F16ToRgba64F, CFormat::F16FromRgba64F, SL2_TBITS(16, 0, 0, 0), SL2_TSHIFTS(0, 0, 0, 0), 2 ) },
		{ SL2_ID( VK_FORMAT_R16G16_SFLOAT, DXGI_FORMAT_R16G16_FLOAT, MTLPixelFormatRG16Float, GL_RG16F, GL_HALF_FLOAT, GL_RG ),								0x00, 0, 32, 1, 1, 1, 1, 1, false, false, false, true, nullptr, SL2_CONV_F( CFormat::F16ToRgba64F, CFormat::F16FromRgba64F, SL2_TBITS(16, 16, 0, 0), SL2_TSHIFTS(0, 16, 0, 0), 4 ) },
		{ SL2_ID( VK_FORMAT_R16G16B16_SFLOAT, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_RGB16F, GL_HALF_FLOAT, GL_RGB ),								0x00, 0, 48, 1, 1, 1, 1, 1, false, false, false, true, nullptr, SL2_CONV_F( CFormat::F16ToRgba64F, CFormat::F16FromRgba64F, SL2_TBITS(16, 16, 16, 0), SL2_TSHIFTS(0, 16, 32, 0), 6 ) },
		{ SL2_ID( VK_FORMAT_R16G16B16A16_SFLOAT, DXGI_FORMAT_R16G16B16A16_FLOAT, MTLPixelFormatRGBA16Float, GL_RGBA16F, GL_HALF_FLOAT, GL_RGBA ),			0x00, 0, 64, 1, 1, 1, 1, 1, false, false, false, true, nullptr, SL2_CONV_F( CFormat::F16ToRgba64F, CFormat::F16FromRgba64F, SL2_TBITS(16, 16, 16, 16), SL2_TSHIFTS(0, 16, 32, 48), 8 ) },
		...
		{ SL2_ID( VK_FORMAT_R32_SFLOAT, DXGI_FORMAT_R32_FLOAT, MTLPixelFormatR32Float, GL_R32F, GL_FLOAT, GL_RED ),											0x00, 0, 32, 1, 1, 1, 1, 1, false, false, false, true, nullptr, SL2_CONV_F( CFormat::F32ToRgba64F, CFormat::F32FromRgba64F, SL2_TBITS(32, 0, 0, 0), SL2_TSHIFTS(0, 0, 0, 0), 4 ) },
		{ SL2_ID( VK_FORMAT_R32G32_SFLOAT, DXGI_FORMAT_R32G32_FLOAT, MTLPixelFormatRG32Float, GL_RG32F, GL_FLOAT, GL_RG ),									0x00, 0, 64, 1, 1, 1, 1, 1, false, false, false, true, nullptr, SL2_CONV_F( CFormat::F32ToRgba64F, CFormat::F32FromRgba64F, SL2_TBITS(32, 32, 0, 0), SL2_TSHIFTS(0, 32, 0, 0), 8 ) },
		{ SL2_ID( VK_FORMAT_R32G32B32_SFLOAT, DXGI_FORMAT_R32G32B32_FLOAT, MTLPixelFormatInvalid, GL_RGB32F, GL_FLOAT, GL_RGB ),							0x00, 0, 96, 1, 1, 1, 1, 1, false, false, false, true, nullptr, SL2_CONV_F( CFormat::F32ToRgba64F, CFormat::F32FromRgba64F, SL2_TBITS(32, 32, 32, 0), SL2_TSHIFTS(0, 32, 64, 0), 12 ) },
		{ SL2_ID( VK_FORMAT_R32G32B32A32_SFLOAT, DXGI_FORMAT_R32G32B32A32_FLOAT, MTLPixelFormatRGBA32Float, GL_RGBA32F, GL_FLOAT, GL_RGBA ),				0x00, 0, 128, 1, 1, 1, 1, 1, false, false, false, true, nullptr, SL2_CONV_F( CFormat::F32ToRgba64F, CFormat::F32FromRgba64F, SL2_TBITS(32, 32, 32, 32), SL2_TSHIFTS(0, 32, 64, 96), 16 ) },
		...
		{ SL2_ID( VK_FORMAT_R64_SFLOAT, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_INVALID, GL_INVALID, GL_INVALID ),									0x00, 0, 64, 1, 1, 1, 1, 1, false, false, false, true, nullptr, SL2_CONV_F( CFormat::F64ToRgba64F, CFormat::F64FromRgba64F, SL2_TBITS(64, 0, 0, 0), SL2_TSHIFTS(0, 0, 0, 0), 8 ) },
		{ SL2_ID( VK_FORMAT_R64G64_SFLOAT, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_INVALID, GL_INVALID, GL_INVALID ),								0x00, 0, 128, 1, 1, 1, 1, 1, false, false, false, true, nullptr, SL2_CONV_F( CFormat::F64ToRgba64F, CFormat::F64FromRgba64F, SL2_TBITS(64, 64, 0, 0), SL2_TSHIFTS(0, 64, 0, 0), 16 ) },
		{ SL2_ID( VK_FORMAT_R64G64B64_SFLOAT, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_INVALID, GL_INVALID, GL_INVALID ),								0x00, 0, 192, 1, 1, 1, 1, 1, false, false, false, true, nullptr, SL2_CONV_F( CFormat::F64ToRgba64F, CFormat::F64FromRgba64F, SL2_TBITS(64, 64, 64, 0), SL2_TSHIFTS(0, 64, 128, 0), 24 ) },
		{ SL2_ID( VK_FORMAT_R64G64B64A64_SFLOAT, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_INVALID, GL_INVALID, GL_INVALID ),							0x00, 0, 256, 1, 1, 1, 1, 1, false, false, false, true, nullptr, SL2_CONV_F( CFormat::F64ToRgba64F, CFormat::F64FromRgba64F, SL2_TBITS(64, 64, 64, 64), SL2_TSHIFTS(0, 64, 128, 192), 32 ) },
		...
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_RGBA12, GL_UNSIGNED_SHORT, GL_RGBA ),									0x01, 0, 64, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_GEN_INT( SL2_TBITS(1, 16, 16, 16), SL2_TSHIFTS(0, 16, 32, 48), 8, false, true, false ) },
		...
		{ SL2_ID( VK_FORMAT_B10G11R11_UFLOAT_PACK32, DXGI_FORMAT_R11G11B10_FLOAT, MTLPixelFormatRG11B10Float, GL_R11F_G11F_B10F, GL_UNSIGNED_INT_10F_11F_11F_REV, GL_RGB ),
																																							0x01, 0, 32, 1, 1, 1, 1, 1, false, false, false, true, nullptr, CFormat::R11G11B10FToRgba64F, CFormat::R11G11B10FFromRgba64F },
		{ SL2_ID( VK_FORMAT_E5B9G9R9_UFLOAT_PACK32, DXGI_FORMAT_R9G9B9E5_SHAREDEXP, MTLPixelFormatRGB9E5Float, GL_RGB9_E5, GL_UNSIGNED_INT_5_9_9_9_REV, GL_RGB ),
																																							0x01, 0, 32, 1, 1, 1, 1, 1, false, false, false, true, nullptr, CFormat::RGB9E5ToRgba64F, CFormat::RGB9E5FromRgba64F },
		
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_ALPHA4, GL_UNSIGNED_BYTE, GL_ALPHA ),									0x00, 0, 4, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(0, 8), SL2_LSHIFTS(0, 0), 1, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_A8_UNORM, MTLPixelFormatA8Unorm, GL_ALPHA8, GL_UNSIGNED_BYTE, GL_ALPHA ),								0x00, 0, 8, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(0, 8), SL2_LSHIFTS(0, 0), 1, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_ALPHA8_SNORM, GL_BYTE, GL_ALPHA ),									0x00, 0, 8, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(0, 8), SL2_LSHIFTS(0, 0), 1, true, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_ALPHA8UI_EXT, GL_UNSIGNED_BYTE, GL_ALPHA_INTEGER ),					0x00, 0, 8, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(0, 8), SL2_LSHIFTS(0, 0), 1, false, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_ALPHA8I_EXT, GL_BYTE, GL_ALPHA_INTEGER ),								0x00, 0, 8, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(0, 8), SL2_LSHIFTS(0, 0), 1, true, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_ALPHA12, GL_UNSIGNED_SHORT, GL_ALPHA ),								0x00, 0, 12, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(0, 16), SL2_LSHIFTS(0, 0), 2, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_ALPHA16, GL_UNSIGNED_SHORT, GL_ALPHA ),								0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(0, 16), SL2_LSHIFTS(0, 0), 2, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_ALPHA16_SNORM, GL_SHORT, GL_ALPHA ),									0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(0, 16), SL2_LSHIFTS(0, 0), 2, true, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_ALPHA16UI_EXT, GL_UNSIGNED_SHORT, GL_ALPHA_INTEGER ),					0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(0, 16), SL2_LSHIFTS(0, 0), 2, false, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_ALPHA16I_EXT, GL_SHORT, GL_ALPHA_INTEGER ),							0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(0, 16), SL2_LSHIFTS(0, 0), 2, true, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_ALPHA16F_ARB, GL_HALF_FLOAT, GL_ALPHA ),								0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, true, nullptr, SL2_CONV_F( CFormat::LumAlphaFToRgba64F, CFormat::LumAlphaFFromRgba64F, SL2_LBITS(0, 16), SL2_LSHIFTS(0, 0), 2 ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_ALPHA32UI_EXT, GL_UNSIGNED_INT, GL_ALPHA_INTEGER ),					0x00, 0, 32, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(0, 32), SL2_LSHIFTS(0, 0), 4, false, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_ALPHA32I_EXT, GL_INT, GL_ALPHA_INTEGER ),								0x00, 0, 32, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(0, 32), SL2_LSHIFTS(0, 0), 4, true, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_ALPHA32F_ARB, GL_FLOAT, GL_ALPHA ),									0x00, 0, 32, 1, 1, 1, 1, 1, false, false, false, true, nullptr, SL2_CONV_F( CFormat::LumAlphaFToRgba64F, CFormat::LumAlphaFFromRgba64F, SL2_LBITS(0, 32), SL2_LSHIFTS(0, 0), 4 ) },
		
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE4, GL_UNSIGNED_BYTE, GL_LUMINANCE ),							0x00, 0, 4, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(8, 0), SL2_LSHIFTS(0, 0), 1, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE8, GL_UNSIGNED_BYTE, GL_LUMINANCE ),							0x00, 0, 8, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(8, 0), SL2_LSHIFTS(0, 0), 1, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE8_SNORM, GL_BYTE, GL_LUMINANCE ),							0x00, 0, 8, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(8, 0), SL2_LSHIFTS(0, 0), 1, true, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_SLUMINANCE8, GL_UNSIGNED_BYTE, GL_LUMINANCE ),						0x00, 0, 8, 1, 1, 1, 1, 1, true, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(8, 0), SL2_LSHIFTS(0, 0), 1, false, true, true ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE8UI_EXT, GL_UNSIGNED_BYTE, GL_LUMINANCE_INTEGER ),			0x00, 0, 8, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(8, 0), SL2_LSHIFTS(0, 0), 1, false, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE8I_EXT, GL_BYTE, GL_LUMINANCE_INTEGER ),						0x00, 0, 8, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(8, 0), SL2_LSHIFTS(0, 0), 1, true, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE12, GL_UNSIGNED_SHORT, GL_LUMINANCE ),						0x00, 0, 12, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(16, 0), SL2_LSHIFTS(0, 0), 2, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE16, GL_UNSIGNED_SHORT, GL_LUMINANCE ),						0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(16, 0), SL2_LSHIFTS(0, 0), 2, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE16_SNORM, GL_SHORT, GL_LUMINANCE ),							0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(16, 0), SL2_LSHIFTS(0, 0), 2, true, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE16UI_EXT, GL_UNSIGNED_SHORT, GL_LUMINANCE_INTEGER ),			0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(16, 0), SL2_LSHIFTS(0, 0), 2, false, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE16I_EXT, GL_SHORT, GL_LUMINANCE_INTEGER ),					0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(16, 0), SL2_LSHIFTS(0, 0), 2, true, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE16F_ARB, GL_HALF_FLOAT, GL_LUMINANCE ),						0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, true, nullptr, SL2_CONV_F( CFormat::LumAlphaFToRgba64F, CFormat::LumAlphaFFromRgba64F, SL2_LBITS(16, 0), SL2_LSHIFTS(0, 0), 2 ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE32UI_EXT, GL_UNSIGNED_INT, GL_LUMINANCE_INTEGER ),			0x00, 0, 32, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(32, 0), SL2_LSHIFTS(0, 0), 4, false, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE32I_EXT, GL_INT, GL_LUMINANCE_INTEGER ),						0x00, 0, 32, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(32, 0), SL2_LSHIFTS(0, 0), 4, true, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE32F_ARB, GL_FLOAT, GL_LUMINANCE ),							0x00, 0, 32, 1, 1, 1, 1, 1, false, false, false, true, nullptr, SL2_CONV_F( CFormat::LumAlphaFToRgba64F, CFormat::LumAlphaFFromRgba64F, SL2_LBITS(32, 0), SL2_LSHIFTS(0, 0), 4 ) },
		
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE4_ALPHA4, GL_UNSIGNED_BYTE, GL_LUMINANCE_ALPHA ),			0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(8, 8), SL2_LSHIFTS(0, 8), 2, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE6_ALPHA2, GL_UNSIGNED_BYTE, GL_LUMINANCE_ALPHA ),			0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(8, 8), SL2_LSHIFTS(0, 8), 2, false, true, false ) },	// Weird result.
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE8_ALPHA8, GL_UNSIGNED_BYTE, GL_LUMINANCE_ALPHA ),			0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(8, 8), SL2_LSHIFTS(0, 8), 2, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE8_ALPHA8_SNORM, GL_BYTE, GL_LUMINANCE_ALPHA ),				0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(8, 8), SL2_LSHIFTS(0, 8), 2, true, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_SLUMINANCE8_ALPHA8, GL_UNSIGNED_BYTE, GL_LUMINANCE_ALPHA ),			0x00, 0, 16, 1, 1, 1, 1, 1, true, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(8, 8), SL2_LSHIFTS(0, 8), 2, false, true, true ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE_ALPHA8UI_EXT, GL_UNSIGNED_BYTE, GL_LUMINANCE_ALPHA_INTEGER ),
																																							0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(8, 8), SL2_LSHIFTS(0, 8), 2, false, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE_ALPHA8I_EXT, GL_BYTE, GL_LUMINANCE_ALPHA_INTEGER ),			0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(8, 8), SL2_LSHIFTS(0, 8), 2, true, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE12_ALPHA4, GL_UNSIGNED_SHORT, GL_LUMINANCE_ALPHA ),			0x00, 0, 32, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(16, 16), SL2_LSHIFTS(0, 16), 4, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE12_ALPHA12, GL_UNSIGNED_SHORT, GL_LUMINANCE_ALPHA ),			0x00, 0, 32, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(16, 16), SL2_LSHIFTS(0, 16), 4, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE16_ALPHA16, GL_UNSIGNED_SHORT, GL_LUMINANCE_ALPHA ),			0x00, 0, 32, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(16, 16), SL2_LSHIFTS(0, 16), 4, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE16_ALPHA16_SNORM, GL_SHORT, GL_LUMINANCE_ALPHA ),			0x00, 0, 32, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(16, 16), SL2_LSHIFTS(0, 16), 4, true, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE_ALPHA16UI_EXT, GL_UNSIGNED_SHORT, GL_LUMINANCE_ALPHA_INTEGER ),
																																							0x00, 0, 32, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(16, 16), SL2_LSHIFTS(0, 16), 4, false, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE_ALPHA16I_EXT, GL_SHORT, GL_LUMINANCE_ALPHA_INTEGER ),		0x00, 0, 32, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(16, 16), SL2_LSHIFTS(0, 16), 4, true, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE_ALPHA16F_ARB, GL_HALF_FLOAT, GL_LUMINANCE_ALPHA ),			0x00, 0, 32, 1, 1, 1, 1, 1, false, false, false, true, nullptr, SL2_CONV_F( CFormat::LumAlphaFToRgba64F, CFormat::LumAlphaFFromRgba64F, SL2_LBITS(16, 16), SL2_LSHIFTS(0, 16), 4 ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE_ALPHA32UI_EXT, GL_UNSIGNED_INT, GL_LUMINANCE_ALPHA_INTEGER ),
																																							0x00, 0, 64, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(32, 32), SL2_LSHIFTS(0, 32), 8, false, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE_ALPHA32I_EXT, GL_INT, GL_LUMINANCE_ALPHA_INTEGER ),			0x00, 0, 64, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(32, 32), SL2_LSHIFTS(0, 32), 8, true, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_LUMINANCE_ALPHA32F_ARB, GL_FLOAT, GL_LUMINANCE_ALPHA ),				0x00, 0, 64, 1, 1, 1, 1, 1, false, false, false, true, nullptr, SL2_CONV_F( CFormat::LumAlphaFToRgba64F, CFormat::LumAlphaFFromRgba64F, SL2_LBITS(32, 32), SL2_LSHIFTS(0, 32), 8 ) },
		
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_INTENSITY4, GL_UNSIGNED_BYTE, GL_LUMINANCE ),							0x00, 0, 4, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_IN( CFormat::IntensityToRgba64F, CFormat::IntensityFromRgba64F, SL2_IBITS(8), 1, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_INTENSITY8, GL_UNSIGNED_BYTE, GL_LUMINANCE ),							0x00, 0, 8, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_IN( CFormat::IntensityToRgba64F, CFormat::IntensityFromRgba64F, SL2_IBITS(8), 1, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_INTENSITY8_SNORM, GL_BYTE, GL_LUMINANCE ),							0x00, 0, 8, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_IN( CFormat::IntensityToRgba64F, CFormat::IntensityFromRgba64F, SL2_IBITS(8), 1, true, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_INTENSITY8UI_EXT, GL_UNSIGNED_BYTE, GL_LUMINANCE_INTEGER ),			0x00, 0, 8, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_IN( CFormat::IntensityToRgba64F, CFormat::IntensityFromRgba64F, SL2_IBITS(8), 1, false, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_INTENSITY8I_EXT, GL_BYTE, GL_LUMINANCE_INTEGER ),						0x00, 0, 8, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_IN( CFormat::IntensityToRgba64F, CFormat::IntensityFromRgba64F, SL2_IBITS(8), 1, true, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_INTENSITY12, GL_UNSIGNED_SHORT, GL_LUMINANCE ),						0x00, 0, 12, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_IN( CFormat::IntensityToRgba64F, CFormat::IntensityFromRgba64F, SL2_IBITS(16), 2, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_INTENSITY16, GL_UNSIGNED_SHORT, GL_LUMINANCE ),						0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_IN( CFormat::IntensityToRgba64F, CFormat::IntensityFromRgba64F, SL2_IBITS(16), 2, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_INTENSITY16_SNORM, GL_SHORT, GL_LUMINANCE ),							0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_IN( CFormat::IntensityToRgba64F, CFormat::IntensityFromRgba64F, SL2_IBITS(16), 2, true, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_INTENSITY16UI_EXT, GL_UNSIGNED_SHORT, GL_LUMINANCE_INTEGER ),			0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_IN( CFormat::IntensityToRgba64F, CFormat::IntensityFromRgba64F, SL2_IBITS(16), 2, false, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_INTENSITY16I_EXT, GL_SHORT, GL_LUMINANCE_INTEGER ),					0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_IN( CFormat::IntensityToRgba64F, CFormat::IntensityFromRgba64F, SL2_IBITS(16), 2, true, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_INTENSITY16F_ARB, GL_HALF_FLOAT, GL_LUMINANCE ),						0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_IN( CFormat::IntensityToRgba64F, CFormat::IntensityFromRgba64F, SL2_IBITS(16), 2, false, true, true ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_INTENSITY32UI_EXT, GL_UNSIGNED_INT, GL_LUMINANCE_INTEGER ),			0x00, 0, 32, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_IN( CFormat::IntensityToRgba64F, CFormat::IntensityFromRgba64F, SL2_IBITS(32), 4, false, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_INTENSITY32I_EXT, GL_INT, GL_LUMINANCE_INTEGER ),						0x00, 0, 32, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_IN( CFormat::IntensityToRgba64F, CFormat::IntensityFromRgba64F, SL2_IBITS(32), 4, true, false, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_INTENSITY32F_ARB, GL_FLOAT, GL_LUMINANCE ),							0x00, 0, 32, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_IN( CFormat::IntensityToRgba64F, CFormat::IntensityFromRgba64F, SL2_IBITS(32), 4, false, true, true ) },
		...
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_COMPRESSED_LUMINANCE, GL_UNSIGNED_BYTE, GL_LUMINANCE ),				0x00, 0, 8, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(8, 0), SL2_LSHIFTS(0, 0), 1, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_COMPRESSED_SLUMINANCE, GL_UNSIGNED_BYTE, GL_LUMINANCE ),				0x00, 0, 8, 1, 1, 1, 1, 1, true, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(8, 0), SL2_LSHIFTS(0, 0), 1, false, true, true ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_COMPRESSED_LUMINANCE_ALPHA, GL_UNSIGNED_BYTE, GL_LUMINANCE_ALPHA ),	0x00, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(8, 8), SL2_LSHIFTS(0, 8), 2, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_COMPRESSED_SLUMINANCE_ALPHA, GL_UNSIGNED_BYTE, GL_LUMINANCE_ALPHA ),	0x00, 0, 16, 1, 1, 1, 1, 1, true, false, false, false, nullptr, SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(8, 8), SL2_LSHIFTS(0, 8), 2, false, true, true ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_COMPRESSED_INTENSITY, GL_UNSIGNED_BYTE, GL_LUMINANCE ),				0x00, 0, 8, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_CONV_IN( CFormat::IntensityToRgba64F, CFormat::IntensityFromRgba64F, SL2_IBITS(8), 1, false, true, false ) },
		...
		{ SL2_ID( VK_FORMAT_BC1_RGB_UNORM_BLOCK, DXGI_FORMAT_BC1_UNORM, MTLPixelFormatInvalid, GL_COMPRESSED_RGB_S3TC_DXT1_EXT, GL_UNSIGNED_BYTE, GL_RGB ),	0x02, 0, 64, 4, 4, 1, 1, 1, false, true, false, false, CFormat::GetCompressedSizeBc, CFormat::Dxt1ToRgba64F<false>, CFormat::Dxt1FromRgba64F<0, false> },
		//{ SL2_KIF_GL_COMPRESSED_RGBA_S3TC_DXT1_EXT, SL2_KT_GL_UNSIGNED_BYTE, SL2_KBIF_GL_RGBA, 0x02, 0, 64, 4, 4, 1, 1, 1, false, true, false, false, nullptr, CFormat::Dxt1ToRgba64F<false>, CFormat::Dxt1FromRgba64F<128, false> },
		//{ SL2_KIF_GL_COMPRESSED_RGBA_S3TC_DXT3_EXT, SL2_KT_GL_UNSIGNED_BYTE, SL2_KBIF_GL_RGBA, 0x02, 0, 128, 4, 4, 1, 1, 1, false, true, false, false, nullptr, CFormat::Dxt3ToRgba64F<false>, CFormat::Dxt3FromRgba32F<false> },
		//{ SL2_KIF_GL_COMPRESSED_RGBA_S3TC_DXT5_EXT, SL2_KT_GL_UNSIGNED_BYTE, SL2_KBIF_GL_RGBA, 0x02, 0, 128, 4, 4, 1, 1, 1, false, true, false, false, nullptr, CFormat::Dxt5ToRgba32F<false>, CFormat::Dxt5FromRgba32F<false> },
		//{ SL2_KIF_GL_COMPRESSED_SRGB_S3TC_DXT1_EXT, SL2_KT_GL_UNSIGNED_BYTE, SL2_KBIF_GL_RGB, 0x02, 0, 64, 4, 4, 1, 1, 1, true, true, false, false, nullptr, CFormat::Dxt1ToRgba64F<true>, CFormat::Dxt1FromRgba64F<0, true> },
		//{ SL2_KIF_GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT, SL2_KT_GL_UNSIGNED_BYTE, SL2_KBIF_GL_RGBA, 0x02, 0, 64, 4, 4, 1, 1, 1, true, true, false, false, nullptr, CFormat::Dxt1ToRgba64F<true>, CFormat::Dxt1FromRgba64F<128, true> },
		//{ SL2_KIF_GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT, SL2_KT_GL_UNSIGNED_BYTE, SL2_KBIF_GL_RGBA, 0x02, 0, 128, 4, 4, 1, 1, 1, true, true, false, false, nullptr, CFormat::Dxt3ToRgba64F<true>, CFormat::Dxt3FromRgba32F<true> },
		//{ SL2_KIF_GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT, SL2_KT_GL_UNSIGNED_BYTE, SL2_KBIF_GL_RGBA, 0x02, 0, 128, 4, 4, 1, 1, 1, true, true, false, false, nullptr, CFormat::Dxt5ToRgba32F<true>, CFormat::Dxt5FromRgba32F<true> },
		// 
