...
#define SL2_ID( VULKAN, DX, METAL, OGLINTERNAL, OGLTYPE, OGLBASE )				#VULKAN, #DX, #METAL, #OGLINTERNAL, #OGLTYPE, #OGLBASE, SL2_ ## VULKAN, SL2_ ## DX, SL2_ ## METAL, SL2_ ## OGLINTERNAL, SL2_KT_ ## OGLTYPE, SL2_KBIF_ ## OGLBASE
		...
		//{ GL_COMPRESSED_RGB_FXT1_3DFX, GL_INVALID, GL_INVALID, 0x00, 0, 0, 1, 1, 1, 1, 1, false, false, false, false, nullptr },
		//{ GL_COMPRESSED_RGBA_FXT1_3DFX, GL_INVALID, GL_INVALID, 0x00, 0, 0, 1, 1, 1, 1, 1, false, false, false, false, nullptr },
		...
		//{ GL_COMPRESSED_RGB_BPTC_SIGNED_FLOAT, GL_FLOAT, GL_RGB, 0x02, 0, 128, 4, 4, 1, 1, 1, false, true, false, nullptr, /**/nullptr, nullptr /*CFormat::Bc6hToRgba64F<false>, CFormat::Bc6hFromRgba64F<false>*/ },
		...
		//{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_ATC_RGB_AMD, GL_UNSIGNED_BYTE, GL_RGB ),							0x02, 0, 64, 4, 4, 1, 1, 1, false, true, false, nullptr,								nullptr, 0, PVRTLVT_Invalid, { PVRTLCN_NoChannel }, },
		...
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_COLOR_INDEX1_EXT, GL_UNSIGNED_BYTE, GL_COLOR_INDEX ),					SL2_MAKE_IDX_FLAG, 0, 1, 1, 1, 1, 1, 1, false, false, false, false, GetSizeIndexed<uint8_t>, SL2_TBITS(0, 0, 0, 0), SL2_TSHIFTS(0, 0, 0, 0), CFormat::IndexedToRgba64F<uint8_t, 1>, CFormat::IndexedFromRgba64F<uint8_t, 1>,						nullptr, 0, PVRTLVT_Invalid, { PVRTLCN_NoChannel }, },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_COLOR_INDEX2_EXT, GL_UNSIGNED_BYTE, GL_COLOR_INDEX ),					SL2_MAKE_IDX_FLAG, 0, 2, 1, 1, 1, 1, 1, false, false, false, false, GetSizeIndexed<uint8_t>, SL2_TBITS(0, 0, 0, 0), SL2_TSHIFTS(0, 0, 0, 0), CFormat::IndexedToRgba64F<uint8_t, 2>, CFormat::IndexedFromRgba64F<uint8_t, 2>,						nullptr, 0, PVRTLVT_Invalid, { PVRTLCN_NoChannel }, },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_COLOR_INDEX4_EXT, GL_UNSIGNED_BYTE, GL_COLOR_INDEX ),					SL2_MAKE_IDX_FLAG, 0, 4, 1, 1, 1, 1, 1, false, false, false, false, GetSizeIndexed<uint8_t>, SL2_TBITS(0, 0, 0, 0), SL2_TSHIFTS(0, 0, 0, 0), CFormat::IndexedToRgba64F<uint8_t, 4>, CFormat::IndexedFromRgba64F<uint8_t, 4>,						nullptr, 0, PVRTLVT_Invalid, { PVRTLCN_NoChannel }, },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_COLOR_INDEX8_EXT, GL_UNSIGNED_BYTE, GL_COLOR_INDEX ),					SL2_MAKE_IDX_FLAG, 0, 8, 1, 1, 1, 1, 1, false, false, false, false, GetSizeIndexed<uint8_t>, SL2_TBITS(0, 0, 0, 0), SL2_TSHIFTS(0, 0, 0, 0), CFormat::IndexedToRgba64F<uint8_t, 8>, CFormat::IndexedFromRgba64F<uint8_t, 8>,						nullptr, 0, PVRTLVT_Invalid, { PVRTLCN_NoChannel }, },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_COLOR_INDEX12_EXT, GL_UNSIGNED_SHORT, GL_COLOR_INDEX ),				SL2_MAKE_IDX_FLAG, 0, 12, 1, 1, 1, 1, 1, false, false, false, false, GetSizeIndexed<uint8_t>, SL2_TBITS(0, 0, 0, 0), SL2_TSHIFTS(0, 0, 0, 0), CFormat::IndexedToRgba64F<uint16_t, 12>, CFormat::IndexedFromRgba64F<uint16_t, 12>,					nullptr, 0, PVRTLVT_Invalid, { PVRTLCN_NoChannel }, },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_COLOR_INDEX16_EXT, GL_UNSIGNED_SHORT, GL_COLOR_INDEX ),				SL2_MAKE_IDX_FLAG, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, GetSizeIndexed<uint16_t>, SL2_TBITS(0, 0, 0, 0), SL2_TSHIFTS(0, 0, 0, 0), CFormat::IndexedToRgba64F<uint16_t, 16>, CFormat::IndexedFromRgba64F<uint16_t, 16>,					nullptr, 0, PVRTLVT_Invalid, { PVRTLCN_NoChannel }, },
...
#define SL2_SRGB_CHROMAS								{ 0.640, 0.330, 0.212639005871510 },		{ 0.300, 0.600, 0.715168678767756 },		{ 0.150, 0.060, 0.072192315360734 },		{ 0.31272, 0.32903, 1.0000 }
#define SL2_SMPTE_170M_CHROMAS							{ 0.630, 0.340, 0.2988390 },				{ 0.310, 0.595, 0.5868110 },				{ 0.155, 0.070, 0.1143500 },				{ 0.31272, 0.32903, 1.0000 }
#define SL2_BT_601_525_CHROMA							{ 0.630, 0.340, 0.2988390 },				{ 0.310, 0.595, 0.5868110 },				{ 0.155, 0.070, 0.1143500 },				{ 0.31272, 0.32903, 1.0000 }
#define SL2_BT_601_625_CHROMA							{ 0.640, 0.330, 0.2988390 },				{ 0.290, 0.600, 0.5868110 },				{ 0.150, 0.060, 0.1143500 },				{ 0.31272, 0.32903, 1.0000 }
...
#define SL2_POW_1_8_CURVE								{ 1.8 }, 1
...
#undef SL2_GENERIC_RGB_PROFILE_CHROMAS
