...
#define SL2_ID( VULKAN, DX, METAL, OGLINTERNAL, OGLTYPE, OGLBASE )				#VULKAN, #DX, #METAL, #OGLINTERNAL, #OGLTYPE, #OGLBASE, SL2_ ## VULKAN, SL2_ ## DX, SL2_ ## METAL, SL2_KIF_ ## OGLINTERNAL, SL2_KT_ ## OGLTYPE, SL2_KBIF_ ## OGLBASE
		...
		{ SL2_ID( VK_FORMAT_B8G8R8_UNORM, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_RGB8, GL_UNSIGNED_BYTE, GL_BGR ),									0x00, 0, 24, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_GEN_INT( SL2_TBITS(8, 8, 8, 0), SL2_TSHIFTS(16, 8, 0, 0), 3, false, true, false ) },
		...
		{ SL2_ID( VK_FORMAT_R8G8B8A8_SINT, DXGI_FORMAT_R8G8B8A8_SINT, MTLPixelFormatRGBA8Sint, GL_RGBA8I, GL_BYTE, GL_RGBA_INTEGER ),						0x00, 0, 32, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_GEN_INT( SL2_TBITS(8, 8, 8, 8), SL2_TSHIFTS(0, 8, 16, 24), 4, true, false, false ) },
		{ SL2_ID( VK_FORMAT_B8G8R8A8_SINT, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_RGBA8I, GL_BYTE, GL_BGRA_INTEGER ),								0x00, 0, 32, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_GEN_INT( SL2_TBITS(8, 8, 8, 8), SL2_TSHIFTS(16, 8, 0, 24), 4, true, false, false ) },
		...
		{ SL2_ID( VK_FORMAT_R8_SRGB, DXGI_FORMAT_UNKNOWN, MTLPixelFormatR8Unorm_sRGB, GL_SR8_EXT, GL_UNSIGNED_BYTE, GL_RED ),								0x00, 0, 8, 1, 1, 1, 1, 1, true, false, false, false, nullptr, SL2_GEN_INT( SL2_TBITS(8, 0, 0, 0), SL2_TSHIFTS(0, 0, 0, 0), 1, false, true, true ) },
		...
		{ SL2_ID( VK_FORMAT_R8G8_SRGB, DXGI_FORMAT_UNKNOWN, MTLPixelFormatRG8Unorm_sRGB, GL_SRG8_EXT, GL_UNSIGNED_BYTE, GL_RG ),							0x00, 0, 16, 1, 1, 1, 1, 1, true, false, false, false, nullptr, SL2_GEN_INT( SL2_TBITS(8, 8, 0, 0), SL2_TSHIFTS(0, 8, 0, 0), 2, false, true, true ) },
		...
		{ SL2_ID( VK_FORMAT_R4G4_UNORM_PACK8, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_INVALID, GL_INVALID, GL_INVALID ),								0x01, 0, 8, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_GEN_INT( SL2_TBITS(4, 4, 0, 0), SL2_TSHIFTS(4, 0, 0, 0), 1, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_RGB4, GL_UNSIGNED_SHORT_4_4_4_4, GL_RGB ),							0x01, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_GEN_INT( SL2_TBITS(4, 4, 4, 0), SL2_TSHIFTS(0, 4, 8, 0), 2, false, true, false ) },
		{ SL2_ID( VK_FORMAT_UNDEFINED, DXGI_FORMAT_UNKNOWN, MTLPixelFormatInvalid, GL_RGB4, GL_UNSIGNED_SHORT_4_4_4_4_REV, GL_RGB ),						0x01, 0, 16, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_GEN_INT( SL2_TBITS(4, 4, 4, 0), SL2_TSHIFTS(8, 4, 0, 0), 2, false, true, false ) },
		...
		{ SL2_ID( VK_FORMAT_A8_UNORM_KHR, DXGI_FORMAT_A8_UNORM, MTLPixelFormatA8Unorm, GL_ALPHA8, GL_UNSIGNED_BYTE, GL_ALPHA ),								0x00, 0, 8, 1, 1, 1, 1, 1, false, false, false, false, nullptr, SL2_TBITS(0, 0, 0, 8), SL2_TSHIFTS(0, 0, 0, 0), SL2_CONV_L( CFormat::LumAlphaToRgba64F, CFormat::LumAlphaFromRgba64F, SL2_LBITS(0, 8), SL2_LSHIFTS(0, 0), 1, false, true, false ) },
...
#define SL2_BUILD_TABLE									{ 0.0 }, 0
	...
	CFormat::SL2_TRANSFER_FUNCS CFormat::m_tfColorspaceTransfers[] = {
		...
		{ CUtilities::PassThrough,						CUtilities::PassThrough,								// SL2_CGC_GENERIC_FILM
			SL2_GENERIC_FILM_CHROMAS, SL2_LINEAR_CURVE, L"Generic Film" },

		{ CUtilities::Pow2_2toLinear,					CUtilities::LinearToPow2_2,								// SL2_CGC_ITU_BT_470_M_NTSC
			SL2_BT_470_NTSC_CHROMA, SL2_POW_2_2_CURVE, L"ITU BT.470 (M/NTSC)" },
		{ CUtilities::Pow2_2toLinear,					CUtilities::LinearToPow2_2,								// SL2_CGC_ITU_BT_470_M_PAL
			SL2_BT_470_NTSC_CHROMA, SL2_POW_2_8_CURVE, L"ITU BT.470 (M/PAL)" },
		{ CUtilities::Pow2_8toLinear,					CUtilities::LinearToPow2_8,								// SL2_CGC_ITU_BT_470_B_N_PAL
			SL2_BT_470_PAL_CHROMA, SL2_POW_2_8_CURVE, L"ITU BT.470 (B, B1, D, D1, G, H, K, N/PAL, K1, L/SECAM)" },

		{ CUtilities::PassThrough,						CUtilities::PassThrough,								// SL2_CGC_ACESCG
			SL2_ACESCG_CHROMAS, SL2_LINEAR_CURVE, L"ACEScg" },

		{ CUtilities::SMPTE170MtoLinear_Precise,		CUtilities::LinearToSMPTE170M_Precise,					// SL2_CGC_NTSC_1987_STANDARD
			SL2_SMPTE_170M_CHROMAS, SL2_SMPTE_170M_1999_PRECISE_CURVE, L"Standard NTSC 1987 (SMPTE C)" },
		{ CUtilities::Pow2_2toLinear,					CUtilities::LinearToPow2_2,								// SL2_CGC_NTSC_1987
			SL2_SMPTE_170M_CHROMAS, SL2_POW_2_2_CURVE, L"NTSC 1987 (SMPTE C)" },

		{ CUtilities::RommRgbToLinear,					CUtilities::LinearToRommRgb,							// SL2_CGC_ROMM_RGB
			SL2_ROMM_RGB_CHROMA, SL2_ROMM_RGB_CURVE, L"Reference Output Medium Metric RGB (ROMM RGB)" },
		{ CUtilities::RimmRgbToLinear,					CUtilities::LinearToRimmRgb,							// SL2_CGC_RIMM_RGB
			SL2_ROMM_RGB_CHROMA, SL2_BUILD_TABLE, L"Reference Input Medium Metric RGB (RIMM RGB)" },
		{ CUtilities::ErimmRgbToLinear,					CUtilities::LinearToErimmRgb,							// SL2_CGC_ERIMM_RGB
			SL2_ROMM_RGB_CHROMA, SL2_BUILD_TABLE, L"Extended Reference Input Medium Metric RGB (ERIMM RGB)" },

		{ CUtilities::PassThrough,						CUtilities::PassThrough,								// SL2_CGC_PLASA_ANSI_E154
			SL2_PLASA_ANSI_E154_CHROMA, SL2_LINEAR_CURVE, L"PLASA ANSI E1.54" },
	};
