...
namespace sl2 {
	...
	public :
		...
		static inline double SL2_FASTCALL					SMPTE170MtoLinear_Precise( double _dVal ) {
			if ( _dVal < -0.08124285829863515939752716121802222914993762969970703125 ) { return -std::pow( (-_dVal + 0.09929682680944297568093048766968422569334506988525390625) / 1.09929682680944297568093048766968422569334506988525390625, 1.0 / 0.45 ); }
		...
		static inline double SL2_FASTCALL					LinearToSMPTE170M_Precise( double _dVal ) {
			if ( _dVal < -0.01805396851080781108 ) { return -1.09929682680944297568093048766968422569334506988525390625 * std::pow( -_dVal, 0.45 ) + 0.09929682680944297568093048766968422569334506988525390625; }
			return _dVal <= 0.01805396851080781108 ?
				_dVal * 4.5 :
