...
#define SL2_ADV( VAL )							_iArgC -= (VAL); _wcpArgV += (VAL); continue
 ...
 #define SL2_COLORSPACE( CMD, VAR, FILEVAR, EXTRA )                                                                                                                                                                                                                                                                                                                                  \
	if ( SL2_CHECK( 2, CMD ) ) {                                                                                                                                                                                                                                                                                                                                                    \
		...
		else if ( ::_wcsicmp( _wcpArgV[1], L"rec709_apple" ) == 0 || ::_wcsicmp( _wcpArgV[1], L"rec.709_apple" ) == 0 || ::_wcsicmp( _wcpArgV[1], L"bt709_apple" ) == 0 || ::_wcsicmp( _wcpArgV[1], L"bt.709_apple" ) == 0 || ::_wcsicmp( _wcpArgV[1], L"itu_bt709_apple" ) == 0 || ::_wcsicmp( _wcpArgV[1], L"itu_bt.709_apple" ) == 0 ) {											\
			oOptions.VAR = sl2::SL2_CGC_APPLE_ITU_BT_709;                                                                                                                                                                                                                                                                                                                           \
		}                                                                                                                                                                                                                                                                                                                                                                           \
		...
		else if ( ::_wcsicmp( _wcpArgV[1], L"bt2020_apple" ) == 0 || ::_wcsicmp( _wcpArgV[1], L"bt.2020_apple" ) == 0 || ::_wcsicmp( _wcpArgV[1], L"itu_bt2020_apple" ) == 0 || ::_wcsicmp( _wcpArgV[1], L"itu_bt.2020_apple" ) == 0 ) {																																			\
			oOptions.VAR = sl2::SL2_CGC_APPLE_ITU_BT_2020;																																																																															\
		}                                                                                                                                                                                                                                                                                                                                                                           \
		...
		else if ( ::_wcsicmp( _wcpArgV[1], L"dcip3_apple" ) == 0 || ::_wcsicmp( _wcpArgV[1], L"dci-p3_apple" ) == 0 || ::_wcsicmp( _wcpArgV[1], L"dci_p3_apple" ) == 0 ) {                                                                                                                                                                                                          \
			oOptions.VAR = sl2::SL2_CGC_APPLE_DCI_P3;                                                                                                                                                                                                                                                                                                                               \
		}                                                                                                                                                                                                                                                                                                                                                                           \
		...
		else if ( ::_wcsicmp( _wcpArgV[1], L"displayp3_apple" ) == 0 || ::_wcsicmp( _wcpArgV[1], L"display-p3_apple" ) == 0 || ::_wcsicmp( _wcpArgV[1], L"display_p3_apple" ) == 0 ) {																																																\
			oOptions.VAR = sl2::SL2_CGC_APPLE_EBU_DISPLAY_P3;                                                                                                                                                                                                                                                                                                                       \
		}                                                                                                                                                                                                                                                                                                                                                                           \
		...
		else if ( ::_wcsicmp( _wcpArgV[1], L"generic_rgb" ) == 0 || ::_wcsicmp( _wcpArgV[1], L"generic_rgb_profile" ) == 0 ) {                                                                                                                                                                                                                                                      \
			oOptions.VAR = sl2::SL2_CGC_GENERIC_RGB;																																																																																\
		}                                                                                                                                                                                                                                                                                                                                                                           \
		else if ( ::_wcsicmp( _wcpArgV[1], L"generic_rgb_apple" ) == 0 || ::_wcsicmp( _wcpArgV[1], L"generic_rgb_profile_apple" ) == 0 ) {                                                                                                                                                                                                                                          \
			oOptions.VAR = sl2::SL2_CGC_APPLE_GENERIC_RGB;																																																																															\
		}                                                                                                                                                                                                                                                                                                                                                                           \
		...
		else if ( ::_wcsicmp( _wcpArgV[1], L"acescg_apple" ) == 0 || ::_wcsicmp( _wcpArgV[1], L"acescgapple" ) == 0 ) {                                                                                                                                                                                                                                                             \
		    oOptions.VAR = sl2::SL2_CGC_APPLE_ACESCG;                                                                                                                                                                                                                                                                                                                               \
		}                                                                                                                                                                                                                                                                                                                                                                           \
		...
		else if ( ::_wcsicmp( _wcpArgV[1], L"color_lcd" ) == 0 || ::_wcsicmp( _wcpArgV[1], L"colorlcd" ) == 0 ) {																																																								                                    \
			oOptions.VAR = sl2::SL2_CGC_COLOR_LCD;																																																																									                                \
		}                                                                                                                                                                                                                                                                                                                                                                           \
		else {                                                                                                                                                                                                                                                                                                                                                                      \
			SL2_ERRORT( std::format( L"Invalid \"" #CMD "\": \"{}\". Must be adobergb, acescg, acescg_apple, bt2020, bt2020_apple, bt2020_std, bt470_ntsc, bt470_pal, bt470_secam, color_lcd, dci_p3, dci_p3_apple, displayp3, displayp3_apple, displayp3_std, erimm_rgb, generic_film, generic_rgb, generic_rgb_apple, gopro, ntsc_1953, ntsc_1953_std, "							\
				"ntsc_1987, ntsc_1987_std, plasa, rec601, rec601_pal, rec601_pal_std, rec601_std, rec709, rec709_apple, rec709_std, rimm_rgb, romm_rgb, s-gamut, s-gamut3, s-gamut3_cine, smpte_170, smpte_170_std, smpte_240, smpte_240_std, smpte_c, smpte_c_std, sRGB, sRGB_std, tech_3213, or tech_3213_std.",																	\
				_wcpArgV[1] ).c_str(), sl2::SL2_E_INVALIDCALL );                                                                                                                                                                                                                                                                                                                    \
		}                                                                                                                                                                                                                                                                                                                                                                           \
...
#define SL2_RESAMPLE( COND, ASSIGN, COPY )																																															\
	if ( SL2_CHECK( 2, COND ) ) {																																																	\
		if ( ::_wcsicmp( _wcpArgV[1], L"box" ) == 0 || ::_wcsicmp( _wcpArgV[1], L"point" ) == 0 ) {																																	\
		...
		else if ( ::_wcsicmp( _wcpArgV[1], L"robidoux" ) == 0 ) {																																									\
			oOptions.ASSIGN = sl2::CResampler::SL2_FF_ROBIDOUX;																																										\
		}																																																							\
		else if ( ::_wcsicmp( _wcpArgV[1], L"robidouxsharp" ) == 0 ) {																																								\
			oOptions.ASSIGN = sl2::CResampler::SL2_FF_ROBIDOUXSHARP;																																								\
		}																																																							\
		else if ( ::_wcsicmp( _wcpArgV[1], L"robidouxsoft" ) == 0 ) {																																								\
			oOptions.ASSIGN = sl2::CResampler::SL2_FF_ROBIDOUXSOFT;																																									\
		}																																																							\
		...
		else if ( ::_wcsicmp( _wcpArgV[1], L"adobebicubic" ) == 0 || ::_wcsicmp( _wcpArgV[1], L"adobebc" ) == 0 ) {																													\
			oOptions.ASSIGN = sl2::CResampler::SL2_FF_ADOBEBICUBIC;																																									\
		}																																																							\
			...
			::_wcsicmp( _wcpArgV[1], L"adobebicubicsharp" ) == 0 || ::_wcsicmp( _wcpArgV[1], L"adobebcsharp" ) == 0 ) {																												\
			...
			SL2_ERRORT( std::format( L"Invalid \"" #COND "\": \"{}\". Must be box, tent, quadraticsharp, quadratic, quadraticapprox, quadraticmix, kaiser, lanczos2, lanczos3, lanczos4, lanczos6, lanczos8, lanczos12, lanczos64, "\
				"mitchell, robidoux, robidouxsharp, robidouxsoft, catmul, bspline, adobebicubic, cardinal, adobebicubicsharp, hermite, hamming, hanning, blackman, gaussiansharp, gaussian, or bell.",								\
				_wcpArgV[1] ).c_str(), sl2::SL2_E_INVALIDCALL );																																									\
		}																																																							\
		...
		SL2_ADV( 2 );																																																				\
			...
			SL2_RESAMPLE( filterc, fFilterFuncW, oOptions.fFilterFuncH = oOptions.fFilterFuncD );
			SL2_RESAMPLE( filter_color, fFilterFuncW, oOptions.fFilterFuncH = oOptions.fFilterFuncD );
			...
			SL2_RESAMPLE( mip_filterc, fMipFilterFuncW, oOptions.fMipFilterFuncH = oOptions.fMipFilterFuncD );
			SL2_RESAMPLE( mip_filter_color, fMipFilterFuncW, oOptions.fMipFilterFuncH = oOptions.fMipFilterFuncD );
...
#define SL2_RESAMPLE( CONDITION, FILTER )                                                                                   \
    if ( CONDITION ) {                                                                                                      \
        ...
        SL2_ADV( 1 );                                                                                                       \
				...
				SL2_RESAMPLE( SL2_CHECK( 1, RescaleRobidoux ) || SL2_CHECK( 1, ResampleRobidoux ), SL2_FF_ROBIDOUX )
				SL2_RESAMPLE( SL2_CHECK( 1, RescaleRobidouxSharp ) || SL2_CHECK( 1, ResampleRobidouxSharp ), SL2_FF_ROBIDOUXSHARP )
				SL2_RESAMPLE( SL2_CHECK( 1, RescaleRobidouxSoft ) || SL2_CHECK( 1, ResampleRobidouxSoft ), SL2_FF_ROBIDOUXSOFT )
				...
				SL2_RESAMPLE( SL2_CHECK( 1, RescaleAdobeBicubic ) || SL2_CHECK( 1, ResampleAdobeBicubic ), SL2_FF_ADOBEBICUBIC )
...
#define SL2_CHECKEXT( EXT )     sl2::CFileBase::CmpFileExtension( oOptions.vOutputs[I], u ## #EXT )
		...
		else if ( SL2_CHECKEXT( ktx2 ) || SL2_CHECKEXT( pvr ) || SL2_CHECKEXT( astc ) || SL2_CHECKEXT( h ) ) {
...
namespace sl2 {
	...
	SL2_ERRORS ExportAsPvr( CImage &_iImage, const std::u16string &_sPath, SL2_OPTIONS &_oOptions ) {
		...
		if ( _iImage.Format()->vfVulkanFormat != SL2_VK_FORMAT_UNDEFINED ) {
			if ( !::PVRTexLib_SetTextureVulkanFormat(
				thHeader.thHeader,
				static_cast<PVRTuint32>(_iImage.Format()->vfVulkanFormat) ) ) { return SL2_E_BADFORMAT; }
		}
		else if ( _iImage.Format()->dfDxFormat != SL2_DXGI_FORMAT_UNKNOWN ) {
			if ( !::PVRTexLib_SetTextureDXGIFormat(
				thHeader.thHeader,
