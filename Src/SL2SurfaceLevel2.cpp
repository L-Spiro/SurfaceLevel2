	...
	if ( SL2_CHECK( 2, CMD ) ) {                                                                                                                                                                                                                                                                                                                                                    \
		...
		/*}*/                                                                                                                                                                                                                                                                                                                                                                           \
			...
			SL2_ERRORT( std::format( L"Invalid \"" #CMD "\": \"{}\". Must be sRGB, sRGB_std, smpte_170, smpte_170_std, rec601, rec601_std, rec601_pal, rec601_pal_std, rec709, rec709_std, adobergb, bt2020, bt2020_std, dci_p3, smpte_240, smpte_240_std,"                                                                                                                         \
				"ntsc_1953, ntsc_1953_std, tech_3213, tech_3213_std, generic_film, generic_rgb, bt470_ntsc, bt470_pal, bt470_secam, ntsc_1987, ntsc_1987_std, smpte_c, smpte_c_std, romm_rgb, rimm_rgb, erimm_rgb, gopro, plasa, s-gamut, s-gamut3, s-gamut3_cine, displayp3, or displayp3_std.",                                                                                   \
				_wcpArgV[1] ).c_str(), sl2::SL2_E_INVALIDCALL );                                                                                                                                                                                                                                                                                                                    \
		}                                                                                                                                                                                                                                                                                                                                                                           \
